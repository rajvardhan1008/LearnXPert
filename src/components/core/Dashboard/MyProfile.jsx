...
export default function MyProfile() {
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between rounded-md border-[1px] border-[#5938ff] bg-[#A594F9] p-8 px-12">
      ...
      <div className="my-10 flex flex-col gap-y-10 rounded-md border-[1px] border-[#5938ff] bg-[#A594F9] p-8 px-12">
        ...
        <p
          className={`text-richblack-600 text-sm font-medium`}
        >
