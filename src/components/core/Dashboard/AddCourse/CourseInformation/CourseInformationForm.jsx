...
export default function CourseInformationForm() {
  ...
  return (
    <form
      ...
      className="space-y-8 rounded-md border-[1px] border-[#7358f8] bg-[#A594F9] p-6"
    >
      {/* Course Title */}
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-richblack-900" htmlFor="courseTitle">
          Course Title <sup className="text-richblack-900">*</sup>
        </label>
        <input
          id="courseTitle"
        ...
        />
        {errors.courseTitle && (
          <span className="ml-2 text-xs tracking-wide text-richblack-900">
      ...
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-richblack-900" htmlFor="courseShortDesc">
          Course Short Description <sup className="text-richblack-900">*</sup>
        </label>
        <textarea
          id="courseShortDesc"
      ...
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-richblack-900" htmlFor="coursePrice">
          Course Price <sup className="text-richblack-900">*</sup>
        </label>
      ...
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-richblack-900" htmlFor="courseCategory">
          Course Category <sup className="text-richblack-900">*</sup>
        </label>
        <select
      ...
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-richblack-900" htmlFor="courseBenefits">
          Benefits of the course <sup className="text-richblack-900">*</sup>
        </label>
        <textarea
          id="courseBenefits"
