  ...
  return (
    <>
      ...
      {!enrolledCourses ? (
        ...
        <p className="grid h-[10vh] w-full mt-20 place-content-center text-2xl text-richblack-700">
          Opps...
          <br />
        ...
        <div className="my-8 text-richblack-5">
          {/* Headings */}
          <div className="flex rounded-t-lg bg-[#6141fe] ">
          ...
          {enrolledCourses.map((course, i, arr) => (
            <div
              className={`flex items-center border border-richblack-300 bg-[#A594F9] ${
